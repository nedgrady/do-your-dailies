...
func TestDeleteChoreReturns404WhenNotFound(t *testing.T) {
	...
	rr := httptest.NewRecorder()
	router.ServeHTTP(rr, httptest.NewRequest(http.MethodDelete, "/api/chores/99", nil))
...
func TestDeleteChoreReturns400OnNonNumericID(t *testing.T) {
	...
	rr := httptest.NewRecorder()
	router.ServeHTTP(rr, httptest.NewRequest(http.MethodDelete, "/api/chores/abc", nil))
...
func TestDeleteChoreAcceptsLargeUintID(t *testing.T) {
	...
	rr := httptest.NewRecorder()
	router.ServeHTTP(rr, httptest.NewRequest(http.MethodDelete, "/api/chores/9223372036854775808", nil))
...
func TestDeleteChoreRejectsBase11OnlyID(t *testing.T) {
	...
	rr := httptest.NewRecorder()
	router.ServeHTTP(rr, httptest.NewRequest(http.MethodDelete, "/api/chores/a", nil))
